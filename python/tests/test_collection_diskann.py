...
Mirrors ``test_collection_hnsw_rabitq.py`` but targets DiskAnn.

DiskAnn is currently built only for Linux x86_64 — other platforms are
skipped wholesale.
"""
...
pytestmark = pytest.mark.skipif(
    ...
    reason="DiskAnn is only supported on Linux x86_64",
)
